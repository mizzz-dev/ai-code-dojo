...
- Issue #37（Runner安全性レビュー）はレビュー記録を完了し、設計フォロー（Issue #44）とADR正式化（Issue #46）を完了。Issue #48 / #50 / #52 / #54 / #56 / #58 / #60 / #62 / #64 / #66 / #68 は完了。
...
## 優先順位（直近）
1. Issue #71（Issue #68 完了後の docs 正本同期と next task の単一化）
